...
| `git push --set-upstream <remote> <branch>`<br>`Ex: git push --set-upstream origin dev_rakib` <br>Shorter Version Ex: git push -u origin dev_rakib | Set the upstream branch for the current local branch. |
